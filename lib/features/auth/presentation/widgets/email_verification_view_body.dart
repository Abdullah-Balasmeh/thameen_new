...
class _EmailVerificationViewBodyState extends State<EmailVerificationViewBody>
  ...
  Widget build(BuildContext context) {
    ...
    var emailVerificationCubit = context.watch<EmailVerificationCubit>();
    if (emailVerificationCubit.state is EmailVerificationLoading) {
      isLoading = true;
        ...
        child: Column(
          children: [
            ...
            AppButton(
              ...
              onPressed: () {
                if (isButtonEnabled) {
                  emailVerificationCubit.verifyOtp(
                    widget.userEmail,
                    currentText,
                  );
                }
              ...
              children: [
                ...
                TextButton(
                  onPressed: _canResend
                      ? () {
                          emailVerificationCubit.resendOtp(
                            widget.userEmail,
                          );
                          setState(() {
                            _canResend = false;
